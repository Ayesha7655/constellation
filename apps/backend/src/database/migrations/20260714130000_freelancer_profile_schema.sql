-- Plan 1: org freelancer profile, search filters, extension pairing, import drafts
...
CREATE TABLE IF NOT EXISTS "freelancer_profiles" (
  ...
  CONSTRAINT "freelancer_profiles_org_id_key" UNIQUE ("org_id"),
...
CREATE TABLE IF NOT EXISTS "search_filter_sets" (
  ...
  "created_at" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  "updated_at" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  CONSTRAINT "search_filter_sets_org_id_key" UNIQUE ("org_id"),
