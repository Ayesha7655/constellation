...
import {
  buildUpworkFilterUserPrompt,
  getUpworkFilterSystemPrompt,
} from '../../../common/prompts/builders/upwork-filter.prompt';
...
export class OpenAiFilterProvider {
  ...
  async generate(profile: UpworkFilterGenerationProfile): Promise<UpworkApifySearchFilters | null> {
    ...
    const completion = await client.chat.completions.create({
      ...
      messages: [
        { role: 'system', content: getUpworkFilterSystemPrompt() },
